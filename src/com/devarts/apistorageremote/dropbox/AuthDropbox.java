...
public class AuthDropbox {
    ...
    public void autentica(String a1,String a2, String a3) throws IOException {
...
//        }
        ...
        String argAppInfoFile = a1;
        String argAuthFileOutput = a2;
        ...
        switch (a3) {
            ...
            case "scope":
                ...
                break;
            default:
                System.err.println("Error reading <mode> : " + a3);
                System.exit(1);
        }
